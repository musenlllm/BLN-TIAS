!function(t, e, i, n) {
    ...
    function A(t, e, i) {
        var n = i.pointers.length, s = i.changedPointers.length, r = e & Pt && n - s === 0,
            o = e & (Rt | Mt) && n - s === 0;
    ...
    function S(t, e) {
        ...
        if (e.eventType != Mt && (s > bt || i.velocity === n)) {
            var c = e.deltaX - i.deltaX, h = e.deltaY - i.deltaY, u = O(s, c, h);
    ...
    function H(t, e) {
        ...
        if (r = i.filter(function(t) {
            return f(t.target, l);
        }), e === Pt) for (s = 0; s < r.length;) n[r[s].identifier] = !0, s++;
    ...
    var dt = ['', 'webkit', 'Moz', 'MS', 'ms', 'o'], pt = e.createElement('div'), ft = 'function', vt = Math.round,
        mt = Math.abs, gt = Date.now, Tt;
    ...
    var yt = a(function we(t, e, i) {
            ...
            return t;
        }, 'extend', 'Use `assign`.'), Ct = a(function Ae(t, e) {
            return yt(t, e, !0);
        }, 'merge', 'Use `assign`.'), Et = 1, xt = /mobile|tablet|ip(ad|hone|od)|android/i, $t = 'ontouchstart' in t,
        It = C(t, 'PointerEvent') !== n, wt = $t && xt.test(navigator.userAgent), At = 'touch', Dt = 'pen',
        _t = 'mouse', St = 'kinect', bt = 25, Pt = 1, Ot = 2, Rt = 4, Mt = 8, zt = 1, Nt = 2, Xt = 4, Yt = 8, kt = 16,
        qt = Nt | Xt, Ft = Yt | kt, Wt = qt | Ft, Ht = ['x', 'y'], Lt = ['clientX', 'clientY'];
    I.prototype = {
        handler: function() {
        }, init: function() {
    ...
    var Vt = { mousedown: Pt, mousemove: Ot, mouseup: Rt }, Ut = 'mousedown', jt = 'mousemove mouseup';
    l(Y, I, {
    ...
    var Gt = { pointerdown: Pt, pointermove: Ot, pointerup: Rt, pointercancel: Mt, pointerout: Mt },
        Bt = { 2: At, 3: Dt, 4: _t, 5: St }, Zt = 'pointerdown', Jt = 'pointermove pointerup pointercancel';
    t.MSPointerEvent && !t.PointerEvent && (Zt = 'MSPointerDown', Jt = 'MSPointerMove MSPointerUp MSPointerCancel'), l(k, I, {
        handler: function _e(t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace('ms', ''), s = Gt[n],
                r = Bt[t.pointerType] || t.pointerType, o = r == At, a = g(e, t.pointerId, 'pointerId');
    ...
    var Kt = { touchstart: Pt, touchmove: Ot, touchend: Rt, touchcancel: Mt }, Qt = 'touchstart',
    ...
    l(W, I, {
        handler: function be(t) {
            var e = ee[t.type], i = H.call(this, t, e);
    ...
    l(L, I, {
        handler: function Pe(t, e, i) {
            var n = i.pointerType == At, s = i.pointerType == _t;
            if (!(s && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                if (n) V.call(this, e, i); else if (s && j.call(this, i)) return;
                this.callback(t, e, i);
            }
        }, destroy: function Oe() {
    ...
    var re = C(pt.style, 'touchAction'), oe = re !== n, ae = 'compute', le = 'auto', ce = 'manipulation', he = 'none',
        ue = 'pan-x', de = 'pan-y', pe = Z();
    G.prototype = {
        set: function(t) {
    ...
    J.prototype = {
        ...
        defaults: { pointers: 1 }, attrTest: function(t) {
            ...
            var e = this.state, i = t.eventType, n = e & (ve | me), s = this.attrTest(t);
        ...
        defaults: { event: 'press', pointers: 1, time: 251, threshold: 9 }, getTouchAction: function() {
            ...
            if (this._input = t, !n || !i || t.eventType & (Rt | Mt) && !r) this.reset(); else if (t.eventType & Pt) this.reset(), this._timer = s(function() {
                this.state = Te, this.tryEmit();
            }, e.time, this); else if (t.eventType & Rt) return Te;
            return Ce;
        }, reset: function() {
        ...
        defaults: { event: 'swipe', threshold: 10, velocity: .3, direction: qt | Ft, pointers: 1 },
        getTouchAction: function() {
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[rt, { enable: !1 }], [nt, { enable: !1 }, ['rotate']], [ot, { direction: qt }], [it, { direction: qt }, ['swipe']], [at], [at, {
            event: 'doubletap',
            taps: 2
        }, ['tap']], [st]],
        cssProps: {
    ...
    function t(t) {
        var n = $('.side-nav').find('.is-active'), s = $('.side-nav').children().index(n),
            r = $('.side-nav').children().length - 1, o = 0;
...
// 删除outer
    ...
    function s() {
        $('.slider--prev, .slider--next').click(function() {
            var t = $(this), e = $('.slider').find('.slider--item-left'), i = $('.slider').children().index(e),
                n = $('.slider').find('.slider--item-center'), s = $('.slider').children().index(n),
                r = $('.slider').find('.slider--item-right'), o = $('.slider').children().index(r),
                a = $('.slider').children().length, l = $('.slider--item-left'), c = $('.slider--item-center'),
                h = $('.slider--item-right'), u = $('.slider--item');
            $('.slider').animate({ opacity: 0 }, 400), setTimeout(function() {
            ...
            }, 400), $('.slider').animate({ opacity: 1 }, 400);
        });
    }
    ...
    $(this).on('mousewheel DOMMouseScroll', function(e) {
        ...
        if (!$(this).hasClass('is-active')) {
            var t = $(this), n = t.parent().find('.is-active'), s = t.parent().children().index(n),
                r = t.parent().children().index(t), o = $(this).parent().children().length - 1;
            e(r), i(s, r, o);
        }
    })
        //删除cat，改改改
    //     $('.cta').click(function() {
    //     var t = $('.side-nav').find('.is-active'), n = $('.side-nav').children().index(t),
    //         s = $('.side-nav').children().length - 1, r = s;
    //     e(s), i(n, r, s);
    // })
    ;
    var l = document.getElementById('viewport'), c = new Hammer(l);
    c.get('swipe').set({ direction: Hammer.DIRECTION_VERTICAL }), c.on('swipeup swipedown', function(e) {
        t(e);
