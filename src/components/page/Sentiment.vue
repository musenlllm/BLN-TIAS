<template>
  <div>
    <el-container>
      <el-header style="height: max-content;text-align: center;padding:0">
        <el-card
          class="noBorderInput"
          style="border: 0px;border-radius: 0;max-height: 275px;
                background-color: #fff;
                box-shadow: 0 0px 0px 0 rgba(0,0,0,.1);"
        >
          <h1 style=" letter-spacing: 10px; font-weight: normal; font-size: 25px; margin-top: -20px"
          >情感分析</h1>
          <el-input
            type="textarea"
            placeholder="请输入文本"
      ...
      >
        <el-card
            class="box-card"
            style="height: 240px;background-color: #fff;box-shadow: 0 0px 0px 0 rgba(0,0,0,.1);"
          ...
          >
              ...
              <div
                id="wrap"
                align="middle"
                style="width: 100%;justify-content: center;margin-top: -60px"
              >
                <div id="pos_emoji" style="margin-top: 45px" align="bottom">
                  <span
                    style="font-size:15px;color:#909399;text-align:center;display:block;position:relative;top:40px;margin-right: 15px;letter-spacing: 5px"
                  >正面情绪</span>
                ...
                <div
                  align="middle"
                  id="emotionLevel"
                  style="width:500px;height:400px;margin-top: -90px"
                ></div>

                <div id="neg_emoji" style="margin-left:8px;margin-top: 45px">
                  <img src="../../assets/img/neg2.png" width="100px" />
                  <span
                    style="font-size:15px;color:#909399;text-align:center;display:block;position:relative;top:40px;margin-left: 15px;letter-spacing: 5px"
                  >负面情绪</span>
                </div>
              </div>
          </el-card>
        ...
        <el-row style="max-width: 100%;margin-top: 20px">
          <el-card
            class="box-card"
            style="height:520px;box-shadow: 0 0px 0px 0 rgba(0,0,0,.1);"
            v-loading="resloading"
          >
            ...
            <el-container style="margin: -20px;margin-right: -9px">
              <el-aside
                width="50%"
                style="margin-top:-1px;margin-right: 10px;margin-left: 11px;height:100%"
                align="center"
              >
                <el-row :gutter="0" style="margin-bottom: 0;box-shadow: 0 0px 0px 0 rgba(0,0,0,.1);">
                  <el-col
                    :span="24"
                    style="padding: 0px;margin-top:-2px;margin-bottom:0;margin-left: -1px;margin-right: 1px;box-shadow: 0 0px 0px 0 rgba(0,0,0,.1);"
                  >
                    <el-card
                      :body-style="{padding: '0px',shadow:'never'}"
                      style="border-radius: 0;box-shadow: 0 0px 0px 0 rgba(0,0,0,.1);"
                      shadow="never"
                    >
                      <div class="grid-content grid-con-1" style="color:#E47470 ">
                        <div class="grid-con-text1">
                          <div class="grid-num">今日检测总数</div>
                          <div
                            class="grid-num"
                          >{{today_num = today_negative_count+today_positive_count}} 条</div>
                        </div>
              ...
              <el-main style="margin: -20px;margin-bottom: -20px;margin-right: 0px">
                <el-tabs
                  type="border-card"
                  stretch="true"
                  style="padding:-10%;margin-right:-16px;margin-left: -2px;margin-top:-1px;border-radius: 0;"
                >
                  <el-tab-pane>
                    ...
                    >
                      ...
                      >
                        ...
                        ></el-table-column>
                        <el-table-column prop="news" label="主题和链接" :show-overflow-tooltip="true">
                  ...
                  <el-tab-pane label="负面新闻">
                    ...
                    >
                      <el-table-column
                        ...
                        margin-right="-10%"
                      ></el-table-column>
                      <el-table-column prop="news" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                          <a
                            :href="scope.row.url"
                            target="_blank"
        ...
        >
          ...
          <el-row :gutter="10" style="width: 100%;margin-top: -10px;margin-left: 0.1px">
            <el-col :span="8" style="padding-left: 30px;padding-right: 10px">
              <el-card
                :body-style="{padding: '0px',shadow:'never'}"
                style="box-shadow: 0 0px 0px 0 rgba(0,0,0,.1);"
              >
                <div
                  class="grid-content grid-con-1"
                  style="height:80px;color:#E47470;background-color: white "
                >
                  <div class="grid-con-text" align="center" style="text-align: center;display: flex;align-content: center">
                    <div
                      class="iconof1"
                      style="background-color: #589ef8;border-radius:5px;align-items: center"
                    >
                      <span style="color: #ffffff">
                        <i class="el-icon-s-data" style="font-size: 50px;margin-top:8px;"></i>
                      </span>
                    </div>
                  </div>
                  <!--<el-divider direction="vertical" class="el-div"></el-divider>-->
                  <div class="grid-cont-right1" style="">
            ...
            <el-col :span="8" style="padding-left: 10px;padding-right: 10px">
              ...
              >
                <div
                  class="grid-content grid-con-1"
                  style="height:80px;color:#E47470;background-color: white;align-items: center" align="center"
                >
                  <div class="grid-con-text" style="">
                    <div
                      class="iconof1"
                      style="background-color: #e47470;align-items: center;border-radius:5px;"
                    >
                      <span style="color: #ffffff">
                        <i class="el-icon-top" style="font-size: 50px;margin-top:8px;"></i>
                      </span>
                    </div>
                  </div>
            ...
            <!--<el-col :span="8" style="padding: 0px;margin-top:-2px;margin-left: -1%;margin-right: -1%;">-->
            <el-col :span="8" style="padding-left: 10px;padding-right: 30px">
              <el-card
                :body-style="{padding: '0px',shadow:'never'}"
                style="border-radius: 0;box-shadow: 0 0px 0px 0 rgba(0,0,0,.1);"
              >
                  ...
                  <div
                    class="grid-content grid-con-1" align="center"
                    style="height:80px;color:#E47470;background-color: white; "
                  >
                    <div class="grid-con-text" style="">
                      <div
                        class="iconof1"
                        style="background-color: #8dbf6a;border-radius:5px;"
                      >
                        <span style="color: #ffffff">
                          <i class="el-icon-bottom" style="font-size: 50px;margin-top:5px;"></i>
                        </span>
                      </div>
                    </div>
          ...
          <el-row :gutter="0" align="center" style="width: 100%">
            <el-col :span="12" style="padding: 0">
              <div id="history_trend" align="center" style="width:100%;min-height:400px;"></div>
            </el-col>
            <el-col :span="12" style="padding: 0">
              <div id="hot_theme_sen_dis" align="center" style="width:100%;min-height:400px;"></div>
            </el-col>
          </el-row>
        </el-card>
      ...
      fetch(sentimenturl, {
        ...
        .then((response) => {
          ...
          if (this.classification == "负面") {
            this.sentimentscore = -parseFloat(
            ...
            this.classification =
              ...
              this.classification +
              "(" +
              this.sentimentscore * -100 +
              "%)";
            this.style_sen = "color: #6B2A4A;font-size: 20px;";
          } else {
            this.sentimentscore = parseFloat(response.results[0].score).toFixed(
              2
            );
            this.classification =
              "情感偏" +
    ...
    getRealTimeSentimentInfo() {
      ...
      fetch(realurl, {
        ...
        .then((response) => {
          ...
          this.history_pos_count =
            response.results.nearly_one_week_positive_count;
          this.history_neg_count =
            response.results.nearly_one_week_negative_count;
          this.pos_news = response.results.positive_news;
          this.neg_news = response.results.negative_news;
          this.today_pos_trend =
            response.results.today_positive_news_increase_trend; //,  //每个item为{"timestamp": str, "count": int}
          this.today_neg_trend =
            response.results.today_negative_news_increase_trend; //": [],  //每个item为{"timestamp": str, "count": int}
          this.history_pos_trend =
            response.results.nearly_one_week_positive_news_increase_trend; // int列表
          this.history_neg_trend =
            response.results.nearly_one_week_negative_news_increase_trend;
          // "nearly_one_week_negative_news_increase_trend": []
          this.hot_theme_dis =
            response.results.hot_theme_sentiment_distribution;
          //一天每小时增长图
          var pos_count = [];
          var neg_count = [];
          var each_hour = [];
