  ...
  <div class="outer">
    ...
    <div class="show">
      <div class="schart-box">
            <div class="content-title">结果</div>
            <schart class="schart" canvasId="ring" :options="options"></schart>
      </div>
      <el-row :gutter="20">
        <el-col :span="8">
